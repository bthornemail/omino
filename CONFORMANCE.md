...
- Multimedia bridge conformance gates streaming, render, capture, and transcode effects only for receipt-backed nonempty carriers; media payloads never become identity or proof authority.
...
- Optional visual matrix RTL must keep display output inert and must not become validation or receipt authority.
